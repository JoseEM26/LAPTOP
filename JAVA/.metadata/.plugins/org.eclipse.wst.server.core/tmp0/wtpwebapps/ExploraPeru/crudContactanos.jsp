	...
	<div id="contenedor">
		...
		<div class="container bg-white">
			<div class="row" style="margin: 50px 20px 0px 30px">
				<form action="crudcontacto" method="post">
					<label>Buscar Nombre:</label> <input class="" type="text"
						name="nombre"> <input type="submit" value="buscar">
				</form>
				<%-- 	<div class="col">
				...
				<div class="col">
					...
					<!-- Tabla de Contactos -->
				<c:choose>
    <c:when test="${not empty lstContactos}">
            ...
            <tbody>
                <c:forEach items="${lstContactos}" var="contacto">
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="mostrarContacto?id=${contacto.idContacto}" class="btn btn-outline-primary me-2">Editar</a>
                                <a href="eliminarContacto?id=${contacto.idContacto}" class="btn btn-outline-danger">Eliminar</a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
