		...
		<div class="container bg-white">
			<div class="row" style="margin: 50px 20px 0px 30px">
				...
				<h1>Detalle Boleta</h1>
					<form action="DetalleBoleta" method="post">
						<label>N° Boleta:</label> <input class="" type="text"
							...
							<c:forEach items="${lstDetBoletas}" var="detalle">
								<tr>
									...
									<td>
										<div class="d-flex">
											<a
												href="mostrarDetBoleta?numBol=${detalle.num_bol}&idDestino=${detalle.id_destino}"
												class="btn btn-outline-primary me-2">Editar</a>
											<!-- Enlace para eliminar detalle de la boleta, pasando numBol y idDestino -->
											<a
												href="EliminarDetalleBoleta?numBol=${detalle.num_bol}&idDestino=${detalle.id_destino}"
