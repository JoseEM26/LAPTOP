		...
		<main>
			...
			<div class="container bg-white">
				<div class="row">
					<div class="col-md-3">
						<h3>Filtro</h3>
						<form class="row g-3" action="catalogo" method="post">
					...
					<div class="col-md-9">
						...
						<div class="row">
							...
							<c:forEach items="${lstProductos }" var="p">
									...
									<img alt="foto" class="card-img-top" height="150px"
											src="img/productos/${p.getIdprod() }.png" width="100px"
											onerror="this.src='img/productos/no-imagen.png'">
									<div class="card-body">
										<h5 class="card-title">${p.descripcion }</h5>
										<p class="card-text" 
											style="color: red; font-weight: bold;"><fmt:formatNumber value="${p.getPrecio() }"
												type="currency"></fmt:formatNumber></p>
										<p class="card-text">${p.idcategoria }</p>
										<a href="mostrar?c=${p.getIdprod() }" class="btn btn-primary">Mostrar</a>
									</div>
								</div>	
							...
							<tbody>
								...
								<c:forEach items="${lstProductos }" var="p">
									<tr>
										...
										<th scope="row"><img alt="foto"
											src="img/productos/${p.getIdprod() }.png" width="100px"
											onerror="this.src='img/productos/no-imagen.png'"></th>
										<td>${p.descripcion }</td>
										<td>${p.stock }</td>
										<td><fmt:formatNumber value="${p.getPrecio() }"
												type="currency"></fmt:formatNumber></td>
										<td>${p.idcategoria }</td>
										<td><a href="mostrar?c=${p.getIdprod() }" class="btn btn-outline-primary">
