package com.examen.Examen_T2_EspinozaMoralesJoseAngel_prueba2.Controller;

import com.examen.Examen_T2_EspinozaMoralesJoseAngel_prueba2.Model.Producto;
import com.examen.Examen_T2_EspinozaMoralesJoseAngel_prueba2.Service.CategoriasService;
import com.examen.Examen_T2_EspinozaMoralesJoseAngel_prueba2.Service.ProductoService;
import com.examen.Examen_T2_EspinozaMoralesJoseAngel_prueba2.Service.ProveedorService;
import com.examen.Examen_T2_EspinozaMoralesJoseAngel_prueba2.Utils.Alert;
...
public class ProductoController {
    ...
    private void cargarCombos(Model model) {
        model.addAttribute("categoria", categoriaService.listaProducto());
        model.addAttribute("proveedor", proveedorService.listaProducto());
